...
<div class="wrap">
	<div id="of_container">
		<form action="options.php" method="post" enctype="multipart/form-data">
			...
			<div id="header">
				<div class="logo">
				<h2><?php echo $themenamefull; ?> - Opciones del tema</h2>
				</div>
					<p class="submit">
						<input type="submit" class="button-primary" name="update" value="<?php esc_attr_e( 'Guardar cambios' ); ?>" />
					</p>
			...
			<div class="of_admin_bar">
				...
				<input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( 'Restaurar valores por defecto' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Si pinchas en OK se borrarán todos los datos que hayas introducido. ¡Cuidado!', 'reponse' ) ); ?>' );" />
			</div>
			<div class="clear"></div>
		</form>
	</div> <!-- / #of_container -->  
