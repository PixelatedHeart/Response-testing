...
function response_widgets_init() {
	register_sidebar( array(
		'name' => __( 'Bajo cabecera', 'twentyeleven' ),
		'id' => 'bajo-cabecera',
		'before_widget' => '<div id="%1$s" class="row %2$s" style="text-align:center;">',
		'after_widget' => '</div>',
		'before_title' => '<h2 class="widget-title">',
		'after_title' => '</h2>',
	) );
    register_sidebar(array(
    	'name' => 'Barra derecha (cuando está sola)',
    	'id'   => 'sidebar-widgets',
    ...
    register_sidebar(array(
    	'name' => 'Barra izquierda (cuando están las dos)',
    	'id'   => 'sidebar-left',
    ...
    register_sidebar(array(
    	'name' => 'Barra derecha (cuando están las dos)',
    	'id'   => 'sidebar-right',
 	...
 	register_sidebar( array(
		'name' => __( 'Antes del pie', 'twentyeleven' ),
		'id' => 'antes-del-pie',
		'before_widget' => '<div id="%1$s" class="row %2$s" style="text-align:center;">',
		'after_widget' => '</div>',
		'before_title' => '<h2 class="widget-title">',
